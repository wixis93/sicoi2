...
Insert into SICOI.Tipo_vehiculo (tipo_carro) values ('Sedan'),
('Pick up'),('Familiar'),('Motocicleta'),('Volteo'),('Autobus'),('Tracto Camión'),('Otros');
...
('ARRANCONES O CARRERAS DE VEHÍCULOS','P'),('ASFIXIA','M'),('ASOCIACIÓN DELICTUOSA O PANDILLERISMO','P'),('ATAQUES AL PUDOR','P'),('ATROPELLADO','T'),('ATROPELLAMIENTO DE SEMOVIENTE','T')
,('BLOQUEO DE VÍAS DE COMUNICACIÓN','T'),
...
(68, 'TRI', 'Triumph'),(69, 'VOLKS', 'Volkswagen'),(70, 'VOLVO', 'Volvo'),(71, 'YUGO', 'Yugo'),(72,'OTRO','OTRO');
...
Insert into SICOI.lugar_procedencia(`estado`) values ('Aguascalientes'),
   ('Baja California'),
   ('Baja California Sur'),
   ('Campeche'),
   ('Chiapas'),
